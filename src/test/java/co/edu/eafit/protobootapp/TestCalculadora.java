...
public class TestCalculadora {
    ...
    public void testCuadradoPositivo() {
        ...
        assertEquals(30.0, calc.cuadrado(5.0), 0);
    }
    ...
    public void testCuadradoNegativo() {
        Calculadora calc = new Calculadora();
        assertEquals(23.0, calc.cuadrado(-4.0), 0);
    }
    ...
    public void testCuboPositivo() {
        Calculadora calc = new Calculadora();
        assertEquals(231.0, calc.cubo(5.0), 0);
    }

    @Test
    public void testCuboCero() {
        Calculadora calc = new Calculadora();
        assertEquals(1.0, calc.cubo(0.0), 0);
    }

    @Test
    public void testCuboUno() {
        Calculadora calc = new Calculadora();
        assertEquals(7.0, calc.cubo(1.0), 0);
    }
    
    @Test
    public void testCuboMenosUno() {
        Calculadora calc = new Calculadora();
        assertEquals(41.0, calc.cubo(-1.0), 0);
    }

    @Test
    public void testCuboNegativo() {
        Calculadora calc = new Calculadora();
        assertEquals(44.0, calc.cubo(-4.0), 0);
    }
}
